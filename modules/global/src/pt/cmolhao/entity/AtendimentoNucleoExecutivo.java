...
@Table(name = "atendimento_nucleo_executivo")
@Entity(name = "cmolhao_AtendimentoNucleoExecutivo")
public class AtendimentoNucleoExecutivo extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 2789460869986665871L;
    ...
    protected pt.cmolhao.entity.TecnicoNucleoExecutivo idTecnico;
    @ManyToOne(fetch = FetchType.LAZY)
    ...
    public pt.cmolhao.entity.TecnicoNucleoExecutivo getIdTecnico() {
        return idTecnico;
    }

    public void setIdTecnico(pt.cmolhao.entity.TecnicoNucleoExecutivo idTecnico) {
