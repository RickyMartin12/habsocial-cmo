...
@Table(name = "pessoal_auxiliar_nucleo_executivo")
@Entity(name = "cmolhao_PessoalAuxiliarNucleoExecutivo")
public class PessoalAuxiliarNucleoExecutivo extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 6836267505324309942L;
