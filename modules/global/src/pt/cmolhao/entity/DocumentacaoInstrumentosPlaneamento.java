...
@Table(name = "documentacao_instrumentos_planeamento")
@Entity(name = "cmolhao_DocumentacaoInstrumentosPlaneamento")
public class DocumentacaoInstrumentosPlaneamento extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 1047843429305388440L;
