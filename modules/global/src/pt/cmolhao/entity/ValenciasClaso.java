...
@Table(name = "valencias_claso")
@Entity(name = "cmolhao_ValenciasClaso")
@NamePattern("%s - %s|descricaotecnica,morada")
public class ValenciasClaso extends BaseIntegerIdEntity implements Versioned, SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = -3596850071993046422L;
    ...
    protected InstituicoesClaso idinstituicao;
    ...
    protected Set<AjudasTecnicasClaso> ajudasTecnicasClasos;
    public Set<AjudasTecnicasClaso> getAjudasTecnicasClasos() {
        return ajudasTecnicasClasos;
    }
    public void setAjudasTecnicasClasos(Set<AjudasTecnicasClaso> ajudasTecnicasClasos) {
        this.ajudasTecnicasClasos = ajudasTecnicasClasos;
    }

    @Composition
    @OnDelete(DeletePolicy.CASCADE)
    @OneToMany(mappedBy = "idvalencia")
    protected Set<FotosValenciaClaso> fotosValenciaClasos;
    public Set<FotosValenciaClaso> getFotosValenciaClasos() {
        return fotosValenciaClasos;
    }
    public void setFotosValenciaClasos(Set<FotosValenciaClaso> fotosValenciaClasos) {
        this.fotosValenciaClasos = fotosValenciaClasos;
    }

    @Composition
    @OnDelete(DeletePolicy.CASCADE)
    @OneToMany(mappedBy = "idvalencia")
    protected Set<LocalizacoesClaso> localizacoesClasos;
    public Set<LocalizacoesClaso> getLocalizacoesClasos() {
        return localizacoesClasos;
    }
    public void setLocalizacoesClasos(Set<LocalizacoesClaso> localizacoesClasos) {
        this.localizacoesClasos = localizacoesClasos;
    }

    @Composition
    @OnDelete(DeletePolicy.CASCADE)
    @OneToMany(mappedBy = "idValencia")
    protected Set<UtentesOutrosConcelhosClaso> utentesOutrosConcelhosClasos;
    public Set<UtentesOutrosConcelhosClaso> getUtentesOutrosConcelhosClasos() {
        return utentesOutrosConcelhosClasos;
    }
    public void setUtentesOutrosConcelhosClasos(Set<UtentesOutrosConcelhosClaso> utentesOutrosConcelhosClasos) {
        this.utentesOutrosConcelhosClasos = utentesOutrosConcelhosClasos;
    }
    ...
    public InstituicoesClaso getIdinstituicao() {
        return idinstituicao;
    }

    public void setIdinstituicao(InstituicoesClaso idinstituicao) {
