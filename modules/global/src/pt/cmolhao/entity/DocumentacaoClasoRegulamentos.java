...
@Table(name = "documentacao_claso_regulamentos")
@Entity(name = "cmolhao_DocumentacaoClasoRegulamentos")
public class DocumentacaoClasoRegulamentos extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 959451519390494245L;
