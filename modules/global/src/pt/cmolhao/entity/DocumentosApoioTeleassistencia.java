...
@Table(name = "documentos_apoio_teleassistencia")
@Entity(name = "cmolhao_DocumentosApoioTeleassistencia")
public class DocumentosApoioTeleassistencia extends BaseIntegerIdEntity {
    private static final long serialVersionUID = -8886065823494143480L;
