...
@Table(name = "documentacao_claso_atas")
@Entity(name = "cmolhao_DocumentacaoClasoAtas")
public class DocumentacaoClasoAtas extends BaseIntegerIdEntity {
    private static final long serialVersionUID = -3457806883382539326L;
