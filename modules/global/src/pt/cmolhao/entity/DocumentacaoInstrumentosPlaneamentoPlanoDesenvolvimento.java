...
@Table(name = "documentacao_instrumentos_planeamento_plano_desenvolvimento")
@Entity(name = "cmolhao_DocumentacaoInstrumentosPlaneamentoPlanoDesenvolvimento")
public class DocumentacaoInstrumentosPlaneamentoPlanoDesenvolvimento extends BaseIntegerIdEntity {
    private static final long serialVersionUID = -6593288052116411438L;
