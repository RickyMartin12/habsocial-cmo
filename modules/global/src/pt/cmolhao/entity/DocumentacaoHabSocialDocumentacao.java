...
@Table(name = "documentacao_hab_social_documentacao")
@Entity(name = "cmolhao_DocumentacaoHabSocialDocumentacao")
public class DocumentacaoHabSocialDocumentacao extends BaseIntegerIdEntity {
    private static final long serialVersionUID = -5175001272070720368L;
