...
@Table(name = "documentacao_plataforma_supraconcelhia")
@Entity(name = "cmolhao_DocumentacaoPlataformaSupraconcelhia")
public class DocumentacaoPlataformaSupraconcelhia extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 891546177795562645L;
