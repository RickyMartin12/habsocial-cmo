...
@Table(name = "documentacao_regulamentos")
@Entity(name = "cmolhao_DocumentacaoRegulamentos")
public class DocumentacaoRegulamentos extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 3054429675404124084L;
