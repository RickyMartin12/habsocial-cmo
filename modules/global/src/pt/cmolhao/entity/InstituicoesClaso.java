...
@Table(name = "instituicoes_claso")
@Entity(name = "cmolhao_InstituicoesClaso")
public class InstituicoesClaso extends BaseIntegerIdEntity {
    private static final long serialVersionUID = -7411411541037644232L;
    ...
    protected Set<ValenciasClaso> valenciasClasos;

    public Set<ValenciasClaso> getValenciasClasos() {
        return valenciasClasos;
    }

    public void setValenciasClasos(Set<ValenciasClaso> valenciasClasos) {
        this.valenciasClasos = valenciasClasos;
    }
