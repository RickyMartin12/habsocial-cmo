...
@Table(name = "documentacao_claso_fichas_adesao")
@Entity(name = "cmolhao_DocumentacaoClasoFichasAdesao")
public class DocumentacaoClasoFichasAdesao extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 3710200841302739434L;
