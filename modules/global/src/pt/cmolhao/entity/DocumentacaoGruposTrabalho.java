...
@Table(name = "documentacao_grupos_trabalho")
@Entity(name = "cmolhao_DocumentacaoGruposTrabalho")
public class DocumentacaoGruposTrabalho extends BaseIntegerIdEntity {
    private static final long serialVersionUID = -4832427721045198508L;
