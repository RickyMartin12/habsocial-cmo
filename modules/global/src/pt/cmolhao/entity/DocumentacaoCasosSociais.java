...
@Table(name = "documentacao_casos_sociais")
@Entity(name = "cmolhao_DocumentacaoCasosSociais")
public class DocumentacaoCasosSociais extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 5108096474272547981L;
