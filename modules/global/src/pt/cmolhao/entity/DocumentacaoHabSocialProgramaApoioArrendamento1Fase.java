...
@Table(name = "documentacao_hab_social_programa_apoio_arrendamento_1_fase")
@Entity(name = "cmolhao_DocumentacaoHabSocialProgramaApoioArrendamento1Fase")
public class DocumentacaoHabSocialProgramaApoioArrendamento1Fase extends BaseIntegerIdEntity {
    private static final long serialVersionUID = -2298908038643853284L;
