...
@Table(name = "documentacao_instrumentos_planeamento_diagnostico_social")
@Entity(name = "cmolhao_DocumentacaoInstrumentosPlaneamentoDiagnosticoSocial")
public class DocumentacaoInstrumentosPlaneamentoDiagnosticoSocial extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 1562345140858587754L;
