...
@Table(name = "documentacao_hab_social_programa_apoio_arrendamento_3_fase")
@Entity(name = "cmolhao_DocumentacaoHabSocialProgramaApoioArrendamento3Fase")
public class DocumentacaoHabSocialProgramaApoioArrendamento3Fase extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 3320515974814470338L;
