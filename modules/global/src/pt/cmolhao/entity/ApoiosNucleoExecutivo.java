...
@Table(name = "apoios_nucleo_executivo")
@Entity(name = "cmolhao_ApoiosNucleoExecutivo")
public class ApoiosNucleoExecutivo extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 5653985818853343096L;
