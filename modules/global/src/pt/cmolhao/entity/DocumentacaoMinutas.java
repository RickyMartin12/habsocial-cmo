...
@Table(name = "documentacao_minutas")
@Entity(name = "cmolhao_DocumentacaoMinutas")
public class DocumentacaoMinutas extends BaseIntegerIdEntity {
    private static final long serialVersionUID = -2601901297702610281L;
