...
@Table(name = "instituicoes_nucleo_executivo")
@Entity(name = "cmolhao_InstituicoesNucleoExecutivo")
public class InstituicoesNucleoExecutivo extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 7517015035549578831L;
    ...
    protected Set<ValenciaNucleoExecutivo> valenciaNucleoExecutivos;

    public Set<ValenciaNucleoExecutivo> getValenciaNucleoExecutivos() {
        return valenciaNucleoExecutivos;
    }

    public void setValenciaNucleoExecutivos(Set<ValenciaNucleoExecutivo> valenciaNucleoExecutivos) {
        this.valenciaNucleoExecutivos = valenciaNucleoExecutivos;
    }
    ...
    @OnDelete(DeletePolicy.CASCADE)
    @OneToMany(mappedBy = "idinstituicao")
    protected Set<ProjectoIntervencaoNucleoExecutivo> projectoIntervencaoNucleoExecutivos;

    public Set<ProjectoIntervencaoNucleoExecutivo> getProjectoIntervencaoNucleoExecutivos() {
        return projectoIntervencaoNucleoExecutivos;
    }

    public void setProjectoIntervencaoNucleoExecutivos(Set<ProjectoIntervencaoNucleoExecutivo> projectoIntervencaoNucleoExecutivos) {
        this.projectoIntervencaoNucleoExecutivos = projectoIntervencaoNucleoExecutivos;
    }
    ...
    @OnDelete(DeletePolicy.CASCADE)
    @OneToMany(mappedBy = "idInstituicao")
    protected Set<ApoiosNucleoExecutivo> apoiosNucleoExecutivos;

    public Set<ApoiosNucleoExecutivo> getApoiosNucleoExecutivos() {
        return apoiosNucleoExecutivos;
    }

    public void setApoiosNucleoExecutivos(Set<ApoiosNucleoExecutivo> apoiosNucleoExecutivos) {
        this.apoiosNucleoExecutivos = apoiosNucleoExecutivos;
    }

    @Composition
    @OnDelete(DeletePolicy.CASCADE)
    @OneToMany(mappedBy = "idInstituicao")
    protected Set<TecnicoNucleoExecutivo> tecnicoNucleoExecutivos;

    public Set<TecnicoNucleoExecutivo> getTecnicoNucleoExecutivos() {
        return tecnicoNucleoExecutivos;
    }

    public void setTecnicoNucleoExecutivos(Set<TecnicoNucleoExecutivo> tecnicoNucleoExecutivos) {
        this.tecnicoNucleoExecutivos = tecnicoNucleoExecutivos;
    }
