...
@Table(name = "documentacao_legislacao")
@Entity(name = "cmolhao_DocumentacaoLegislacao")
public class DocumentacaoLegislacao extends BaseIntegerIdEntity {
    private static final long serialVersionUID = 4270618996542295275L;
