...
public class ValenciasBrowse extends StandardLookup<Valencias> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        getWindow().setCaption("Listar Relatórios de Valências - Pessoas Sem Abrigo");
    ...
    private void runExcelDataValenciasPessoasIdosas() {
        ...
        LoadContext<Report> lContext = new LoadContext<>(Report.class);
        lContext.setQueryString("select r from report$Report r where r.id = '6853a54c-66ff-d8fb-22f2-3b1f910bbffb' ");
        Report report = dataService.load(lContext);
    ...
    protected void onPopupButton1PopupAction1(Action.ActionPerformedEvent event) {
        searchCapacidadeInstituicaoPessoasSemAbrigo();

    }

    private void searchCapacidadeInstituicaoPessoasSemAbrigo() {
        LookupField<Instituicoes> institucoes = uiComponents.create(
                LookupField.of(Instituicoes.class));
        dialogs.createInputDialog(this)
                .withCaption("Dados da capacidade de pessoas de uma instituicao na área de intervenção 'pessoas sem abrigo'")
                .withParameters(
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataCapacidadeInstituicaoPessoasSemAbrigo(instituicoes);
    ...
    private void reportDataCapacidadeInstituicaoPessoasSemAbrigo(Instituicoes instituicoes) {
        String outputFile = "";
        ...
        String templateCode = "Estatistica_valencia_PessoasSemAbrigo";
        ...
        if (instituicoes != null)
        {
            outputFile = "Contagem da Capacidade de Elementos da Instituição  '"+instituicoes.getDescricao()+"' da área de intervenção 'pessoas sem abrigo'";
        }
    ...
    protected void onPopupButton1PopupAction2(Action.ActionPerformedEvent event) {
        searchCapacidadeInstituicaoAreaIntervencaoPessoasSemAbrigo();
    }

    private void searchCapacidadeInstituicaoAreaIntervencaoPessoasSemAbrigo() {
        LookupField<Instituicoes> institucoes = uiComponents.create(
                LookupField.of(Instituicoes.class));
        dialogs.createInputDialog(this)
                .withCaption("Dados da capacidade de pessoas de uma instituicao numa dada resposta social na área de intervenção 'Pessoas Sem Abrigo'")
                .withParameters(
                        InputParameter.parameter("idinstituicao")
                                .withField(() -> {
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataCapacidadeInstituicaoAreaIntervencaoPessoasSemAbrigo(instituicoes);
    ...
    private void reportDataCapacidadeInstituicaoAreaIntervencaoPessoasSemAbrigo(Instituicoes instituicoes) {
        String outputFile = "";
        ...
        String templateCode = "Estatistica_instituicao_valencia_PessoasSemAbrigo";
        ...
        if (instituicoes != null)
        {
            outputFile = "Contagem da Capacidade de Elementos da Instituição  '"+instituicoes.getDescricao()+"' na área de intervenção 'pessoas sem abrigo'";
        }
    ...
    protected void onPopupButton1PopupAction3(Action.ActionPerformedEvent event) {
        searchCapacidadeRedeTrabalhoValenciaPessoasSemAbrigo();
    }

    private void searchCapacidadeRedeTrabalhoValenciaPessoasSemAbrigo() {
        LookupField<RedeTrabalho> rede_trabalho_id = uiComponents.create(
                LookupField.of(RedeTrabalho.class));

        dialogs.createInputDialog(this)
                .withCaption("Dados da capacidade de pessoas da rede de trabalho numa dada descrição da valênçia na área de intervenção 'Pessoas Sem Abrigo'")
                .withParameters(
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataCapacidadeValenciasPorMembrosRedePessoasSemAbrigo(redetrabalho);
    ...
    private void reportDataCapacidadeValenciasPorMembrosRedePessoasSemAbrigo(RedeTrabalho redetrabalho) {
        String outputFile = "";
        ...
        String templateCode = "Estatistica_valencia_rede_PessoasSemAbrigo";
        ...
        if (redetrabalho != null)
        {
            outputFile = "Contagem da Capacidade de Elementos da Rede de Trabalho '"+redetrabalho.getNome()+"' nas descrições das valências nas área de intervenção 'Pessoas Sem Abrigo'";
        }
    ...
    protected void onPopupButton1PopupAction4(Action.ActionPerformedEvent event) {
        searchValenciasUtentesporApoioPessoasSemAbrigo();
    }

    private void searchValenciasUtentesporApoioPessoasSemAbrigo() {
        ...
        dialogs.createInputDialog(this)
                .withCaption("Dados do apoio em relacao ao numero de utentes em relação a área de intervenção 'Pessoas Sem Abrigo'")
                .withParameters(
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataUtentesApoiosPessoasSemAbrigo(tipo_apoio, tipo_doc_apoio);
    ...
    private void reportDataUtentesApoiosPessoasSemAbrigo(TipoAjuda tipo_apoio, TipoDocApoio tipo_doc_apoio) {
        ...
        String templateCode = "Estatistica_Valencia_Apoios_PessoasSemAbrigo";
        ...
        {
            outputFile = "Contagem do numero de utentes do Tipo de Apoio  '"+tipo_apoio.getDescricaoTipoAjuda()+"' na área de intervenção 'Pessoas Sem Abrigo'";
        }
        if (tipo_apoio != null && tipo_doc_apoio != null)
        {
            outputFile = "Contagem do numero de utentes do Tipo de Apoio  '"+tipo_apoio.getDescricaoTipoAjuda()+"' e do tipo de documento '"+tipo_doc_apoio.getDescricao()+"' na área de intervenção 'Pessoas Sem Abrigo'";
        }
    ...
    protected void onPopupButton1PopupAction5(Action.ActionPerformedEvent event) {
        searchValenciasApoiosUtentePessoasSemAbrigo();

    }

    private void searchValenciasApoiosUtentePessoasSemAbrigo() {
        LookupField<Utente> utente_id = uiComponents.create(
                LookupField.of(Utente.class));

        dialogs.createInputDialog(this)
                .withCaption("Dados do utente em relacao ao numero de apoios em relação a área de intervenção 'Pessoas Sem Abrigo'")
                .withParameters(
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataApoiosporUtentesPessoasSemAbrigo(utente);
    ...
    private void reportDataApoiosporUtentesPessoasSemAbrigo(Utente utente) {
        String outputFile = "";
        ...
        String templateCode = "Estatistica_Utentes_Apoio_PessoasSemAbrigo";
        ...
        if (utente != null)
        {
            outputFile = "Contagem dos tipos de apoio do utente '"+utente.getNome()+"' na área de intervenção 'Pessoas Sem Abrigo'";
        }
    ...
    protected void onPopupButton1PopupAction6(Action.ActionPerformedEvent event) {
        searchProjetosValenciasPessoasSemAbrigo();

    }

    private void searchProjetosValenciasPessoasSemAbrigo() {
        ...
        dialogs.createInputDialog(this)
                .withCaption("Dados dos projectos de intervenção de uma dada valênçia na área de intervenção 'Pessoas Sem Abrigo'")
                .withParameters(
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataProjetosValenciasPessoasSemAbrigo(projetosintid);
    ...
    private void reportDataProjetosValenciasPessoasSemAbrigo(ProjectosIntervencao projetosintid) {
        String outputFile = "";
        ...
        if (projetosintid != null)
        {
            ...
            reportParams.put("areaIntervencao", 6);
        }


        LoadContext<Report> lContext = new LoadContext<>(Report.class);

        String templateCode = "Estatistica_Valencia_Projectos_PessoasSemAbrigo";
        ...
        if (projetosintid != null)
        {
            outputFile = "Contagem das valênçias do projecto de intervencao '"+projetosintid.getNomeProjecto()+"' na área de intervenção 'Pessoas Sem Abrigo'";
        }
    ...
    protected void onPopupButton1PopupAction7(Action.ActionPerformedEvent event) {
        searchTecnicosDescricaoValenciasPessoasSemAbrigo();
    }

    private void searchTecnicosDescricaoValenciasPessoasSemAbrigo() {
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataTecnicosValenciasPessoasSemAbrigo(tecnicoid);
    ...
    private void reportDataTecnicosValenciasPessoasSemAbrigo(Tecnico tecnicoid) {
        String outputFile = "";
        ...
        String templateCode = "Estatistica_Tecnicos_Valencias_PessoasSemAbrigo";
        ...
        if (tecnicoid != null)
        {
            outputFile = "Contagem das valênçias do tecnico '"+ tecnicoid.getNome()+ "' na área de intervenção 'Pessoas Sem Abrigo'";
        }
