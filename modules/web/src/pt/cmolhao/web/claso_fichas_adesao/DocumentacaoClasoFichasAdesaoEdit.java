...
@UiController("cmolhao_DocumentacaoClasoFichasAdesao.edit")
@UiDescriptor("documentacao-claso-fichas-adesao-edit.xml")
@EditedEntityContainer("documentacaoClasoFichasAdesaoDc")
@LoadDataBeforeShow
public class DocumentacaoClasoFichasAdesaoEdit extends StandardEditor<DocumentacaoClasoFichasAdesao> {
    @Inject
    protected LookupPickerField<RedeTrabalho> idRedeTrabalhoField;
    @Inject
    protected InstanceContainer<DocumentacaoClasoFichasAdesao> documentacaoClasoFichasAdesaoDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoClasoFichasAdesaoDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("Adicionar/Editar Documentacao de Fichas de Adesão do Claso - " + idDocumentacao.getValue());
        ...
        if(idRedeTrabalhoField.getValue() != null)
        {
            ...
            for (SubRedeTrabalho item2 : customers2) {
                ...
                {
                    if (item2.getNome().equals("Fichas de Adesão"))
                    {
        ...
        if (event.isUserOriginated()) {
            if (event.getValue() != null) {
                ...
                for (SubRedeTrabalho item : customers) {
                    ...
                    {
                        if (item.getNome().equals("Fichas de Adesão"))
                        {
                            map.put(item.getNome(), item);
                        }
