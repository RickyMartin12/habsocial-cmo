...
public class DocumentacaoNucleoExecutivoAtasBrowse extends StandardLookup<DocumentacaoNucleoExecutivoAtas> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        getWindow().setCaption("Listar Núcleo Executivo de Atas de Documentos");
    }
    ...
    protected void onDocumentacaoNucleoExecutivoAtasesTableExcel(Action.ActionPerformedEvent event) {
        ...
        if (documentacaoNucleoExecutivoAtasesTable.getSelected().isEmpty())
        {
            dialogs.createOptionDialog()
                    .withCaption("Selecção de documentos do núcleo executivo das atas")
                    .withMessage("Deve seleccionar pelo um dos documentos do núcleo executivo das atas")
                    .withActions(
        ...
        else
        {
            ...
            dialogs.createOptionDialog()
                    .withCaption("Remover a linha da tabela documento do núcleo executivo da ata número '"+user.getId()+"' ")
                    .withMessage("Tens a certeza que quer remover esta linha da tabela documento do núcleo executivo da ata número '"+user.getId()+"'?")
                    .withActions(
