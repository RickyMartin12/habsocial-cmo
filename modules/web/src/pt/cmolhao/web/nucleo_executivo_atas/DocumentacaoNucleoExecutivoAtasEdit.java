...
@UiController("cmolhao_DocumentacaoNucleoExecutivoAtas.edit")
@UiDescriptor("documentacao-nucleo-executivo-atas-edit.xml")
@EditedEntityContainer("documentacaoNucleoExecutivoAtasDc")
@LoadDataBeforeShow
public class DocumentacaoNucleoExecutivoAtasEdit extends StandardEditor<DocumentacaoNucleoExecutivoAtas> {
    @Inject
    ...
    @Inject
    protected InstanceContainer<DocumentacaoNucleoExecutivoAtas> documentacaoNucleoExecutivoAtasDc;
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoNucleoExecutivoAtasDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
