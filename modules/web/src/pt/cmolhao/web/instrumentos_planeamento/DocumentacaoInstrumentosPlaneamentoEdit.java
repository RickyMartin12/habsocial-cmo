...
@UiController("cmolhao_DocumentacaoInstrumentosPlaneamento.edit")
@UiDescriptor("documentacao-instrumentos-planeamento-edit.xml")
@EditedEntityContainer("documentacaoInstrumentosPlaneamentoDc")
@LoadDataBeforeShow
public class DocumentacaoInstrumentosPlaneamentoEdit extends StandardEditor<DocumentacaoInstrumentosPlaneamento> {
    @Inject
    protected InstanceContainer<DocumentacaoInstrumentosPlaneamento> documentacaoInstrumentosPlaneamentoDc;
    @Inject
    protected CollectionContainer<DocumentacaoInstrumentosPlaneamento> documentacaoInstrumentosPlaneamentosDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoInstrumentosPlaneamentoDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("Adicionar/Editar Documentacao Atas do Núcleo Executivo - " + idDocumentacao.getValue());
        ...
        for (RedeTrabalho item : customers) {
            if (item.getNome().equals("Instrumentos de Planeamento"))
            {
        ...
        if(idRedeTrabalhoField.getValue() != null)
        {
            ...
            for (SubRedeTrabalho item2 : customers2) {
                ...
                {
                    if (item2.getNome().equals("Instrumentos de Planeamento"))
                    {
