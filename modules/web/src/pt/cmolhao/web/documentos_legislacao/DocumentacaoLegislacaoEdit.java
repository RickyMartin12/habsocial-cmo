...
@UiController("cmolhao_DocumentacaoLegislacao.edit")
@UiDescriptor("documentacao-legislacao-edit.xml")
@EditedEntityContainer("documentacaoLegislacaoDc")
@LoadDataBeforeShow
public class DocumentacaoLegislacaoEdit extends StandardEditor<DocumentacaoLegislacao> {
    @Inject
    protected InstanceContainer<DocumentacaoLegislacao> documentacaoLegislacaoDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoLegislacaoDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("Adicionar/Editar Documentacao de Legislação - " + idDocumentacao.getValue());
        ...
        if(idRedeTrabalhoField.getValue() != null)
        {
            ...
            for (SubRedeTrabalho item2 : customers2) {
                ...
                {
                    if (item2.getNome().equals("Legislação"))
                    {
