...
public class ApoiosBrowse extends StandardLookup<Apoios> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("List Rel do Apoio 'Teleassistência'");
        ...
        for (TipoDocApoio item : customers) {
            if (item.getIdTipoApoio().getId().equals(602))
            {
                if (item.getId() != null)
                {
    ...
    private void runExcelDataApoios() {
        ...
        // Tipo de Apoio
        reportParams.put("tipo_apoio", 602);
                ...
                .withActions(
                        InputDialogAction.action("pesquisar")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    tipoApoio.setValue(Integer.toString(602));
    ...
    private void reportDataCapacidadeInstituicao(TipoDocApoio tipo_doc_apoio) {
        ...
        reportParams.put("tipo_apoio_id", 602);
        ...
        if (tipo_doc_apoio == null)
        {
            outputFile = "Contagem da Capacidade de Elementos do Tipo de Apoio  'Teleassistência'";
        }
        if (tipo_doc_apoio != null)
        {
            outputFile = "Contagem da Capacidade de Elementos do Tipo de Apoio  'Teleassistência' e do tipo de documento '"+tipo_doc_apoio.getDescricao()+"'";
        }
    ...
    private void reportDataInstituicaoAtendimentos(TipoDocApoio tipo_doc_apoio) {
        ...
        if (tipo_doc_apoio == null)
        {
            outputFile = "Contagem de numero de atendimentos das instituições do Tipo de Apoio  'Teleassistência'";
        }
        if (tipo_doc_apoio != null)
        {
            outputFile = "Contagem de numero de atendimentos das instituições do Tipo de Apoio  'Teleassistência' e do tipo de documento '"+tipo_doc_apoio.getDescricao()+"'";
        }
    ...
    private void reportDataNomeUtentesAtendimentos(TipoDocApoio tipo_doc_apoio) {
        ...
        if (tipo_doc_apoio == null)
        {
            outputFile = "Contagem de numero de atendimentos dos utentes do Tipo de Apoio  'Teleassistência'";
        }
        if (tipo_doc_apoio != null)
        {
            outputFile = "Contagem de numero de atendimentos dos utentes do Tipo de Apoio  'Teleassistência' e do tipo de documento '"+tipo_doc_apoio.getDescricao()+"'";
        }
