...
@UiController("cmolhao_DocumentacaoClasoRegulamentos.edit")
@UiDescriptor("documentacao-claso-regulamentos-edit.xml")
@EditedEntityContainer("documentacaoClasoRegulamentosDc")
@LoadDataBeforeShow
public class DocumentacaoClasoRegulamentosEdit extends StandardEditor<DocumentacaoClasoRegulamentos> {
    @Inject
    protected InstanceContainer<DocumentacaoClasoRegulamentos> documentacaoClasoRegulamentosDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoClasoRegulamentosDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("Adicionar/Editar Documentacao de Regulamentos do Claso - " + idDocumentacao.getValue());
        ...
        if(idRedeTrabalhoField.getValue() != null)
        {
            ...
            for (SubRedeTrabalho item2 : customers2) {
                ...
                {
                    if (item2.getNome().equals("Regulamentos"))
                    {
        ...
        if (event.isUserOriginated()) {
            if (event.getValue() != null) {
                ...
                for (SubRedeTrabalho item : customers) {
                    ...
                    {
                        if (item.getNome().equals("Regulamentos"))
                        {
                            map.put(item.getNome(), item);
                        }
