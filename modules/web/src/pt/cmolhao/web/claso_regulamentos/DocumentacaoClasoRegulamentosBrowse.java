    ...
    protected void onDocumentacaoClasoRegulamentosesTableRemove(Action.ActionPerformedEvent event) {
        ...
        if (documentacaoClasoRegulamentosesTable.getSelected().isEmpty())
        {
            dialogs.createOptionDialog()
                    .withCaption("Selecção de documentos do claso de regulamentos")
        ...
        else
        {
            ...
            dialogs.createOptionDialog()
                    .withCaption("Remover a linha da tabela documento do claso do regulamento número '"+user.getId()+"' ")
                    .withMessage("Tens a certeza que quer remover esta linha da tabela documento do claso do regulamento número '"+user.getId()+"'?")
                    .withActions(
