...
@UiController("cmolhao_ValenciasClaso.edit")
@UiDescriptor("valencias-claso-edit.xml")
@EditedEntityContainer("valenciasClasoDc")
@LoadDataBeforeShow
public class ValenciasClasoEdit extends StandardEditor<ValenciasClaso> {
    ...
    @Inject
    protected CollectionContainer<ValenciasClaso> valenciasesClasoDc;
    @Inject
    protected InstanceContainer<ValenciasClaso> valenciasClasoDc;
    @Inject
    protected Table<FotosValenciaClaso> fotosValenciasTable;
    @Inject
    protected Table<AjudasTecnicasClaso> ajudasTecnicasesTable;
    @Named("ajudasTecnicasesTable.remove")
    protected RemoveAction<AjudasTecnicasClaso> ajudasTecnicasesTableRemove;
    @Named("fotosValenciasTable.remove")
    protected RemoveAction<FotosValenciaClaso> fotosValenciasTableRemove;
    @Inject
    protected Table<LocalizacoesClaso> localizacoesesTable;
    @Named("localizacoesesTable.remove")
    protected RemoveAction<LocalizacoesClaso> localizacoesesTableRemove;
    @Inject
    protected Table<UtentesOutrosConcelhosClaso> utentesOutrosConcelhosesTable;
    @Named("utentesOutrosConcelhosesTable.remove")
    protected RemoveAction<UtentesOutrosConcelhosClaso> utentesOutrosConcelhosesTableRemove;
    @Inject
        ...
        fotosValenciasTable.addGeneratedColumn("download", entity -> {
            ...
            btn.setAction(new BaseAction("download") {
                ...
                public void actionPerform(Component component) {
                    FotosValenciaClaso user = fotosValenciasTable.getSingleSelected();
                    if (user != null)
                    {
    ...
    private Component renderAvatarImageComponent(FotosValenciaClaso vet) {
    ...
    private void onPreCommit(DataContext.PreCommitEvent event) {
        ...
        if (idResSocialField.getValue() != null) {
            if (acordocapacidadeField.getValue() != null) {
                ...
                Collection<ValenciasClaso> customers_valencias = valenciasesClasoDc.getItems();

                for (ValenciasClaso item : customers_valencias) {
    ...
    protected void onAjudasTecnicasesTableRemove(Action.ActionPerformedEvent event) {
        ...
        {
            AjudasTecnicasClaso user = ajudasTecnicasesTable.getSingleSelected();
            dialogs.createOptionDialog()
    ...
    protected void onLocalizacoesesTableRemove(Action.ActionPerformedEvent event) {
        ...
        {
            LocalizacoesClaso user = localizacoesesTable.getSingleSelected();
            dialogs.createOptionDialog()
    ...
    protected void onUtentesOutrosConcelhosesTableRemove(Action.ActionPerformedEvent event) {
        ...
        {
            UtentesOutrosConcelhosClaso user = utentesOutrosConcelhosesTable.getSingleSelected();
            dialogs.createOptionDialog()
    ...
    public Component generateValenciasDescricaoUtentesOutrosConcelhos(UtentesOutrosConcelhosClaso entity) {
    ...
    public Component generateValenciasDescricaoAjudasTecnicas(AjudasTecnicasClaso entity) {
        Label label = (Label) uiComponents.create(Label.NAME);
        if (entity.getIdValencia() != null)
        {
            label.setValue(entity.getIdValencia().getDescricaotecnica());
    ...
    public Component generateValenciasDescricaoFotosValencia(FotosValenciaClaso entity) {
        Label label = (Label) uiComponents.create(Label.NAME);
        if (entity.getIdvalencia() != null)
        {
            label.setValue(entity.getIdvalencia().getDescricaotecnica());
    ...
    public Component generateValenciasDescricaoLocalizacoes(LocalizacoesClaso entity) {
        Label label = (Label) uiComponents.create(Label.NAME);
        if (entity.getIdvalencia() != null)
        {
            label.setValue(entity.getIdvalencia().getDescricaotecnica());
