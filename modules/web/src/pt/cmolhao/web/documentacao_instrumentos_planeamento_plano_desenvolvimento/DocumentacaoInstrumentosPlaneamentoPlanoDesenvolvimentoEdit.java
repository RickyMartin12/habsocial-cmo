...
public class DocumentacaoInstrumentosPlaneamentoPlanoDesenvolvimentoEdit extends StandardEditor<DocumentacaoInstrumentosPlaneamentoPlanoDesenvolvimento> {
    @Inject
    protected InstanceContainer<DocumentacaoInstrumentosPlaneamentoPlanoDesenvolvimento> documentacaoInstrumentosPlaneamentoPlanoDesenvolvimentoDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoInstrumentosPlaneamentoPlanoDesenvolvimentoDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("Adicionar/Editar Documentacao de Instrumentos de Planeamento no Plano de Desenvolvimento - " + idDocumentacao.getValue());
        ...
        if(idRedeTrabalhoField.getValue() != null)
        {
            ...
            for (SubRedeTrabalho item2 : customers2) {
                ...
                {
                    if (item2.getNome().equals("Plano de Desenvolvimento"))
                    {
