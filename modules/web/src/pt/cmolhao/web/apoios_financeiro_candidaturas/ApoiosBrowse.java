...
public class ApoiosBrowse extends StandardLookup<Apoios> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("List Rel do Apoio 'Apoio Financeiro ás Entidades' do documento 'Candidaturas'");
    ...
    private void runExcelDataApoios() {
        ...
        reportParams.put("tipo_doc_apoio", 301);
    ...
    private void reportDataCapacidadeInstituicao() {
        ...
        reportParams.put("tipo_doc_apoio_id", 301);
