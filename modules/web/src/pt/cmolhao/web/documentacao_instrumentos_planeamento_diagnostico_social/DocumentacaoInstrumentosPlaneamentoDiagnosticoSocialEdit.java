...
public class DocumentacaoInstrumentosPlaneamentoDiagnosticoSocialEdit extends StandardEditor<DocumentacaoInstrumentosPlaneamentoDiagnosticoSocial> {
    ...
    @Inject
    protected InstanceContainer<DocumentacaoInstrumentosPlaneamentoDiagnosticoSocial> documentacaoInstrumentosPlaneamentoDiagnosticoSocialDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoInstrumentosPlaneamentoDiagnosticoSocialDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("Adicionar/Editar Documentacao de Instrumentos de Planeamento do Diagnósotico Social - " + idDocumentacao.getValue());
        ...
        if(idRedeTrabalhoField.getValue() != null)
        {
            ...
            for (SubRedeTrabalho item2 : customers2) {
                ...
                {
                    if (item2.getNome().equals("Diagnóstico Social"))
                    {
