...
@UiController("cmolhao_DocumentacaoHabSocialProgramaApoioArrendamento1Fase.edit")
@UiDescriptor("documentacao-hab-social-programa-apoio-arrendamento1-fase-edit.xml")
@EditedEntityContainer("documentacaoHabSocialProgramaApoioArrendamento1FaseDc")
@LoadDataBeforeShow
public class DocumentacaoHabSocialProgramaApoioArrendamento1FaseEdit extends StandardEditor<DocumentacaoHabSocialProgramaApoioArrendamento1Fase> {
    @Inject
    ...
    @Inject
    protected InstanceContainer<DocumentacaoHabSocialProgramaApoioArrendamento1Fase> documentacaoHabSocialProgramaApoioArrendamento1FaseDc;
    ...
    protected void onInit(InitEvent event) {
        ...
        /*dropZone.addLayoutClickListener(e -> {
        ...
        documentacaoHabSocialProgramaApoioArrendamento1FaseDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        getWindow().setCaption("Adicionar/Editar Documentos da Habitação Social no Programa de Apoio ao Arrendamento na 1ª Fase - " + idDocumentacao.getValue());
