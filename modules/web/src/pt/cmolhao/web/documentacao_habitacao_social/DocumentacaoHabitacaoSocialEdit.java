...
public class DocumentacaoHabitacaoSocialEdit extends StandardEditor<DocumentacaoHabitacaoSocial> {
    @Inject
    protected InstanceContainer<DocumentacaoHabitacaoSocial> documentacaoHabitacaoSocialDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoHabitacaoSocialDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        getWindow().setCaption("Adicionar/Editar Documentos de apoios - " + idDocumentacao.getValue());
        ...
        {
            if (idRedeTrabalhoField.getValue().getNome().equals("Programa de Apoio ao Arrendamento"))
            {
