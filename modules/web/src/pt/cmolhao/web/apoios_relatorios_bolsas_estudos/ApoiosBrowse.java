...
public class ApoiosBrowse extends StandardLookup<Apoios> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("List Rel do Apoio 'Bolsas de Estudo'");
        ...
        for (TipoDocApoio item : customers) {
            if (item.getIdTipoApoio().getId().equals(701))
            {
                if (item.getId() != null)
                {
    ...
    private void runExcelDataApoios() {
        ...
        // Tipo de Apoio
        reportParams.put("tipo_apoio", 701);
    ...
    private void apoiosRelatoriosBolsasEstudos (LookupField<TipoDocApoio> field)
    {
        Map<String, TipoDocApoio> map = new HashMap<>();
        Collection<TipoDocApoio> customers = tipoDocApoioDc.getItems();
        for (TipoDocApoio item : customers) {
    ...
    private void serachTipoApoioQuantidadePessoas_AtendimentoUtentes() {
        ...
        apoiosRelatoriosBolsasEstudos(field2);
                ...
                .withActions(
                        InputDialogAction.action("pesquisar")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    tipoApoio.setValue(Integer.toString(701));
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataCapacidadeInstituicao(tipo_doc_apoio);
    ...
    private void reportDataCapacidadeInstituicao(TipoDocApoio tipo_doc_apoio) {
        ...
        reportParams.put("tipo_apoio_id", 701);
        ...
        if (tipo_doc_apoio == null)
        {
            outputFile = "Contagem da Capacidade de Elementos do Tipo de Apoio  'Bolsas de Estudo'";
        }
        if (tipo_doc_apoio != null)
        {
            outputFile = "Contagem da Capacidade de Elementos do Tipo de Apoio  'Bolsas de Estudo' e do tipo de documento '"+tipo_doc_apoio.getDescricao()+"'";
        }
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataCapacidadeAreaIntervencao(tipo_doc_apoio);
    ...
    private void reportDataCapacidadeAreaIntervencao(TipoDocApoio tipo_doc_apoio) {
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataNomeUtentesAtendimentos(tipo_doc_apoio);
                ...
                .withActions(
                        ...
                        InputDialogAction.action("imprimir")
                                ...
                                .withHandler(actionEvent -> {
                                    ...
                                    reportDataInstituicaoAtendimentos(tipo_doc_apoio);
    ...
    private void reportDataInstituicaoAtendimentos(TipoDocApoio tipo_doc_apoio) {
        ...
        if (tipo_doc_apoio == null)
        {
            outputFile = "Contagem de numero de atendimentos das instituições do Tipo de Apoio  'Bolsas de Estudos'";
        }
        if (tipo_doc_apoio != null)
        {
            outputFile = "Contagem de numero de atendimentos das instituições do Tipo de Apoio  'Bolsas de Estudos' e do tipo de documento '"+tipo_doc_apoio.getDescricao()+"'";
        }
    ...
    private void reportDataNomeUtentesAtendimentos(TipoDocApoio tipo_doc_apoio) {
        ...
        if (tipo_doc_apoio == null)
        {
            outputFile = "Contagem de numero de atendimentos dos utentes do Tipo de Apoio  'Bolsas de Estudo'";
        }
        if (tipo_doc_apoio != null)
        {
            outputFile = "Contagem de numero de atendimentos dos utentes do Tipo de Apoio  'Bolsas de Estudo' e do tipo de documento '"+tipo_doc_apoio.getDescricao()+"'";
        }
