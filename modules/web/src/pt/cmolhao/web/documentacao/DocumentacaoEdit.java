...
@UiController("cmolhao_Documentacao.edit")
@UiDescriptor("documentacao-edit.xml")
@EditedEntityContainer("documentacaoDc")
@LoadDataBeforeShow
public class DocumentacaoEdit extends StandardEditor<Documentacao> {
    @Inject
    protected FileUploadField fileField;
    @Inject
    protected InstanceContainer<Documentacao> documentacaoDc;
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        if(idRedeTrabalhoField.getValue() != null)
        {
            ...
            for (SubRedeTrabalho item : customers) {
                if (item.getIdRedeTrabalho().getId().equals(idRedeTrabalhoField.getValue().getId()))
                {
