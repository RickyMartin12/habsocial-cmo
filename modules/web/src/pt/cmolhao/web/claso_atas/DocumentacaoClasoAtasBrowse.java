    ...
    protected void onDocumentacaoClasoAtasesTableRemove(Action.ActionPerformedEvent event) {
        ...
        if (documentacaoClasoAtasesTable.getSelected().isEmpty())
        {
            dialogs.createOptionDialog()
                    .withCaption("Selecção de documentos do claso das atas")
        ...
        else
        {
            ...
            dialogs.createOptionDialog()
                    .withCaption("Remover a linha da tabela documento do claso da ata número '"+user.getId()+"' ")
                    .withMessage("Tens a certeza que quer remover esta linha da tabela documento do claso da ata número '"+user.getId()+"'?")
                    .withActions(
