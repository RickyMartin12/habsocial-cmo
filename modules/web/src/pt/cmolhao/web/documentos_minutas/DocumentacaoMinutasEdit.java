...
@UiController("cmolhao_DocumentacaoMinutas.edit")
@UiDescriptor("documentacao-minutas-edit.xml")
@EditedEntityContainer("documentacaoMinutasDc")
@LoadDataBeforeShow
public class DocumentacaoMinutasEdit extends StandardEditor<DocumentacaoMinutas> {
    @Inject
    protected InstanceContainer<DocumentacaoMinutas> documentacaoMinutasDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoMinutasDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        if(idRedeTrabalhoField.getValue() != null)
        {
            ...
            for (SubRedeTrabalho item2 : customers2) {
                ...
                {
                    if (item2.getNome().equals("Minutas"))
                    {
