...
public class DocumentacaoHabSocialDocumentacaoEdit extends StandardEditor<DocumentacaoHabSocialDocumentacao> {
    @Inject
    protected InstanceContainer<DocumentacaoHabSocialDocumentacao> documentacaoHabSocialDocumentacaoDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoHabSocialDocumentacaoDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
