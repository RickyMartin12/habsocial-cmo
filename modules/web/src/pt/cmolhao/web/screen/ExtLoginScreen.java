...
public class ExtLoginScreen extends Screen {
    ...
    protected void initLocales() {
        ...
        localesSelect.addValueChangeListener(e -> {
            ...
            if (loginScreen instanceof ExtLoginScreen) {
                ((ExtLoginScreen) loginScreen).setAuthInfo(authInfo);
            }
    ...
    protected void showLoginException(String message) {
        ...
        notifications.create(Notifications.NotificationType.ERROR)
                .withCaption(title)
                .withDescription("Nome do Utilizador e Password Incorrectos.")
                .show();
    }
