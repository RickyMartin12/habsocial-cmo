...
@UiController("cmolhao_DocumentacaoRegulamentos.edit")
@UiDescriptor("documentacao-regulamentos-edit.xml")
@EditedEntityContainer("documentacaoRegulamentosDc")
@LoadDataBeforeShow
public class DocumentacaoRegulamentosEdit extends StandardEditor<DocumentacaoRegulamentos> {
    @Inject
    protected InstanceContainer<DocumentacaoRegulamentos> documentacaoRegulamentosDc;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        documentacaoRegulamentosDc.addItemPropertyChangeListener(employeeItemPropertyChangeEvent -> {
    ...
    protected void onAfterShow(AfterShowEvent event) {
        ...
        getWindow().setCaption("Adicionar/Editar Documentacao de Regulamentos - " + idDocumentacao.getValue());
        ...
        for (RedeTrabalho item : customers) {
            if (item.getNome().equals("Documentação"))
            {
